...
latex_documents = [
    (master_doc, 'RADGen.tex', u'RAD Gen Documentation',
     u'RAD Gen Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'radgen', u'RAD Gen Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RADGen', u'RAD Gen Documentation',
     author, 'RADGen', 'One line description of project.',
     'Miscellaneous'),
]
